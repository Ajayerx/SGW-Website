  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-primary/20 rounded-full blur-[150px] floating-element" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-accent/20 rounded-full blur-[150px] floating-element" />
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass border border-primary/20 mb-8 backdrop-blur-xl"
        >
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-[var(--font-heading)] leading-[1.1] mb-8"
        >
          <span className="block text-balance">Transform Your Vision Into</span>
          <motion.span
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative p-4 rounded-2xl glass border border-border/50 hover:border-primary/30 transition-colors">
                <div
        ...
        >
          ...
          <motion.div
            ...
            className="p-2 rounded-full glass border border-border/50 group-hover:border-primary/30"
          >
