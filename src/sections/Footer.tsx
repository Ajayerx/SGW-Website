  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* ─── Main Footer Content ─── */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-10 mb-16">
            {/* Brand Column */}
            <motion.div
                ...
                <div className="flex gap-2 max-w-sm">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 text-sm bg-background/50 border border-border/60 rounded-xl text-foreground placeholder-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
                    />
                  </div>
                  <motion.button
            ...
            {footerLinks.map((section, sectionIndex) => (
              ...
              >
                <h4 className="text-sm font-bold text-foreground tracking-wider uppercase mb-6">
                  {section.title}
                </h4>
                  ...
                  {section.links.map((link, linkIndex) => (
                    ...
                    >
                      <button
                        ...
                        className="text-sm text-muted-foreground/80 hover:text-primary transition-colors duration-200 relative group"
                      >
                        {link.name}
          ...
          <motion.div
            ...
            className="pt-8 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-6"
          >
            ...
            <div className="flex items-center gap-6">
              <button
                type="button"
                className="text-sm text-muted-foreground/70 hover:text-primary transition-colors duration-200 relative group"
              >
                Privacy Policy
                <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-gradient-to-r from-primary to-accent group-hover:w-full transition-all duration-300" />
              </button>
